                    ...
                    <div class="ibox-title">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('blogs.create') }}" class="btn btn-w-m btn-primary">Yeni</a>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($data as $dat)
                                    <tr class="gradeX">
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('blogs.edit', $dat->id) }}"
                                                class="btn btn-warning btn-sm">Yenilə</a>
                                            <form action="{{ route('blogs.destroy', $dat->id) }}" class="d-inline-block"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
