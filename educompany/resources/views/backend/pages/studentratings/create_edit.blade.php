...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Tələbə dəyərləndirmələri</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('dashboard') }}">Dashboard</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="{{ route('studentratings.index') }}">Tələbə dəyərləndirmələri</a>
                </li>
            </ol>
        </div>
    </div>
                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5>Tələbə dəyərləndirmələri</h5>
                            </div>
                            <div class="col-6 text-right">
                                <a href="{{ route('studentratings.index') }}" class="btn btn-w-m btn-default">Geri</a>
                            </div>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <form
                            @if (isset($data) && !empty($data) && isset($data->id)) action="{{ route('studentratings.update', $data->id) }}" @else action="{{ route('studentratings.store') }}" @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if (isset($data) && !empty($data) && isset($data->image) && !empty($data->image))
                                            <img src="{{ getImageUrl($data->image, 'studentratings') }}" alt="image"
                                                width="150">
                                            <br />
                                        @endif
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            value="{{ old('rating', isset($data) && !empty($data) && isset($data->rating) && !empty($data->rating) ? $data->rating : null) }}"
                                            name="rating"
                                            class="form-control {{ $errors->first('rating') ? 'is-invalid' : '' }}">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
