                    ...
                    <div class="ibox-title">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('sliders.create') }}" class="btn btn-w-m btn-primary">Yeni</a>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($data as $dat)
                                    <tr class="gradeX">
                                        ...
                                        <td><img src="{{ getImageUrl($dat->image, 'sliders') ?? null }}" width="222"
                                                alt=""> </td>
                                        <td>{{ $dat->name['az_name'] }}</td>
                                        <td>{{ $dat->order_number }}</td>

                                        <td class="text-right">
                                            <a href="{{ route('sliders.edit', $dat->id) }}"
                                                class="btn btn-warning btn-sm">Yenilə</a>
                                            <form action="{{ route('sliders.destroy', $dat->id) }}" class="d-inline-block"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
