            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{ route('sections.store', $exam_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('time_range_sections') }}" name="time_range_sections" class="form-control {{ $errors->first('time_range_sections') ? 'is-invalid' : '' }}">
                                    </div>
