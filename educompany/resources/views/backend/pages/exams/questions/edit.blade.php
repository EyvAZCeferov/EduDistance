            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{ route('exams.questions.update', [$exam_id, $section_id, $question->id]) }}" method="POST"
                            ...
                            <div class="row" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control {{ $errors->first('type') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach(\App\Models\ExamQuestion::TYPES as $key => $type)
                                                <option {{ old('type', $question->type) == $type ? 'selected' : '' }} value="{{ $type }}">{{ $key }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <img style="max-width: 200px" src="{{ $question->getFirstMedia('exam_question')?->getUrl() }}" alt="">
                                    </div>
                                </div>
                            </div>
