                    ...
                    <div class="ibox-title">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('references.index') }}" class="btn btn-w-m btn-default">Geri</a>
                            </div>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <form
                            @if (isset($data) && !empty($data) && isset($data->id)) action="{{ route('references.update', $data->id) }}" @else action="{{ route('references.store') }}" @endif
