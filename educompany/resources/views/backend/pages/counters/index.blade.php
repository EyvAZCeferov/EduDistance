        ...
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong>Hesabat rəqəmləri</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
                    ...
                    <div class="ibox-title">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('counters.create') }}" class="btn btn-w-m btn-primary">Yeni</a>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($data as $dat)
                                    <tr class="gradeX">
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('counters.edit', $dat->id) }}"
                                                class="btn btn-warning btn-sm">Yenilə</a>
                                            <form action="{{ route('counters.destroy', $dat->id) }}" class="d-inline-block"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
