                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Ad</label>
                                        <input type="text"
                                               value="{{ old('name', $manager->name) }}" name="name"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               value="{{ old('email', $manager->email) }}" name="email"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role_id"
                                            ...
                                            @foreach($roles as $role)
                                                <option
                                                    {{ old('role_id', $manager->role_id) == $role->id ? 'selected' : '' }} value="{{ $role->id }}">{{ $role->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
